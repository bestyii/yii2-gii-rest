<?php
/**
 * @link http://www.bestyii.com/
 * @copyright Copyright (c) 2020 Bestyii.com
 */

namespace bestyii\giiRest\generators\model;
...
class Generator extends \yii\gii\Generator
{
     ...
     */
    private
    function generateManyManyRelations($table, $fks, $relations)
    {
        $db = $this->getDbConnection();
     ...
     */
    protected
    function addInverseRelations($relations)
    {
        $db = $this->getDbConnection();
        $relationNames = [];
     ...
     */
    protected
    function isHasManyRelation($table, $fks)
    {
     ...
     */
    protected
    function checkJunctionTable($table)
    {
     ...
     */
    protected
    function generateRelationName($relations, $table, $key, $multiple)
    {
        static $baseModel;
     ...
     */
    public
    function validateNamespace($attribute)
    {
     ...
     */
    public
    function generateTableName($tableName)
    {
     ...
     */
    protected
    function generateClassName($tableName, $useSchemaName = null)
    {
     ...
     */
    protected
    function generateQueryClassName($modelClassName)
    {
     ...
     */
    protected
    function isColumnAutoIncremental($table, $columns)
    {
